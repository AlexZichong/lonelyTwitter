...
public class ElasticsearchTweetController {
    ...
    // static means only allowed this item once, not dynamic
    public static class AddTweetsTask extends AsyncTask<NormalTweet, Void, Void> {

        @Override
        protected Void doInBackground(NormalTweet... tweets) {  //... means it allows you to put a lot of things without telling how many things
            verifySettings();  // verify the seetings of this particular controller
            ...
            for (NormalTweet tweet : tweets) {
                ...
                try {
                    ...
                    if (result.isSucceeded()){
                        ...
                        Log.i("Error","Elasticsearch is what what whats");
                    }
                }
                catch (Exception e) {
